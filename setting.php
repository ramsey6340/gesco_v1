            ...
            <div class="center">
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <div class="user">
                    <a href="choix-annee-connect.php" class="btn btn-primary btn-user btn-block">
                      Changer d'année scolaire
                    </a>
                  </div><br>
                  <div class="user">
                    <a href="choix-ecole.php" class="btn btn-primary btn-user btn-block">
                      Changer d'ecole
                    </a>
                  </div><br>
                  <div class="user">
