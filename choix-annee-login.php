<?php 
session_start();
  if(isset($_COOKIE['preference_annee'])){
    $_SESSION['id_annee_scolaire'] = $_COOKIE['id_annee_scolaire'];
    $_SESSION['annee_depart'] = $_COOKIE['annee_depart'];
    $_SESSION['annee_fin'] = $_COOKIE['annee_fin'];
    $_SESSION['annee_scolaire'] = $_COOKIE['annee_scolaire'];
                  ...
                  <form class="user" method="post" action="traitement.php">
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                        <input type="checkbox" class="custom-control-input" id="customCheck" name="preference_annee" value="oui">
                        <label class="custom-control-label" for="customCheck">Toujours choisir cette année</label>
                      </div>
                      <div class="custom-control custom-checkbox small">
                        <?php 
                          if(!isset($_SESSION['id_annee_scolaire'])){
                            ?>
                              <input type="checkbox" class="custom-control-input" id="startYear" name="start_year" value="oui">
                              <label class="custom-control-label" for="startYear">Choisir comme etant l'année en cour</label>
                            <?php
                          }
                         ?>
                      </div>
